    ...
    (function(){
        ...
        var attrArray = [ "Total_housing_units", "Vacant_housing_units", "Vacant_housing_units_for_rent", "Vacant_housing_units_for_sale_only" ];
        // capitalized the letters in the attrArray
...
//create a scale to size bars proportional to frame and for axis
        var yScale = d3.scaleLinear()
            ...
            .domain([0, 2500000]); //zero to maximum csv value (rounded)
...
console.log("After setmap");
            ...
            var promises = [];
            promises.push(d3.csv("data/State_table_edits.csv")); //load attribute data
...
//join the attribute data to the spatial data
        function joinData(usStates, ageData){
            ...
            for (var i=0; i<ageData.length; i++){
                ...
                var csvKey = csvState.FIPS //the CSV primary key changed primary key 'State_FIPS_Postal_Code'
                //console.log(csvKey)
